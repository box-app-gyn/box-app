...
exports.SECURITY_UTILS = exports.SECURITY_CONSTANTS = void 0;
...
exports.SECURITY_UTILS = {
    // Verificar se string contém padrões suspeitos
    containsSuspiciousPattern: (input) => {
        return exports.SECURITY_CONSTANTS.SUSPICIOUS_PATTERNS.some(pattern => pattern.test(input));
    },
    // Sanitizar string
    sanitizeString: (input, maxLength = exports.SECURITY_CONSTANTS.VALIDATION.MAX_STRING_LENGTH) => {
    ...
    isValidEmail: (email) => {
        ...
        return emailRegex.test(email) && email.length <= exports.SECURITY_CONSTANTS.VALIDATION.MAX_EMAIL_LENGTH;
    },
    // Validar URL
    isValidUrl: (url) => {
        try {
            ...
            return urlObj.protocol === 'https:' &&
                url.length <= exports.SECURITY_CONSTANTS.VALIDATION.MAX_URL_LENGTH &&
                exports.SECURITY_CONSTANTS.ALLOWED_DOMAINS.some(domain => urlObj.hostname.endsWith(domain));
        }
        catch (_a) {
            return false;
        }
    ...
    isValidPassword: (password) => {
        const errors = [];
        const { PASSWORD_MIN_LENGTH, PASSWORD_MAX_LENGTH, PASSWORD_REQUIREMENTS } = exports.SECURITY_CONSTANTS.AUTH;
    ...
    isSuspiciousUserAgent: (userAgent) => {
        ...
        return exports.SECURITY_CONSTANTS.BLOCKED_USER_AGENTS.some(blocked => lowerUA.includes(blocked));
    },
    // Verificar se rota é protegida
    isProtectedRoute: (pathname) => {
        return exports.SECURITY_CONSTANTS.PROTECTED_ROUTES.some(route => pathname.startsWith(route));
    },
    // Verificar se rota é pública
    isPublicRoute: (pathname) => {
        return exports.SECURITY_CONSTANTS.PUBLIC_ROUTES.some(route => pathname === route || pathname.startsWith(route));
    },
};
