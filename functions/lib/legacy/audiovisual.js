...
exports.validaAudiovisual = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        if (aprovado) {
            ...
            updateData.aprovadoEm = firebase_admin_1.default.firestore.FieldValue.serverTimestamp();
        }
        else {
            updateData.rejeitadoPor = adminId;
            updateData.rejeitadoEm = firebase_admin_1.default.firestore.FieldValue.serverTimestamp();
