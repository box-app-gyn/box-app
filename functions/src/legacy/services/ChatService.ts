...
// Interface simplificada para o repositório
interface IChatRepository {
  saveMessage(message: ChatMessage): Promise<ChatMessage>;
  getMessages(sessionId: string, userId: string, limit?: number): Promise<ChatMessage[]>;
}

// Implementação simples do repositório usando console.log
class SimpleChatRepository implements IChatRepository {
...
export class ChatService {
  ...
  constructor(chatRepository?: IChatRepository) {
    this.chatRepository = chatRepository || new SimpleChatRepository();
  }
