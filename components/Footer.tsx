  ...
  return (
    <footer className="py-6 bg-black text-center">
      {/* Linha visual no topo do footer */}
              <Image src="/images/twolines.png" alt="" className="w-full h-3 object-cover select-none pointer-events-none mb-4" draggable="false" width={400} height={12} />
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-4 mt-8 w-full">
                  <Image src="/images/twolines.png" alt="" className="h-10 md:h-12 max-w-[120px] object-contain select-none pointer-events-none" draggable="false" width={120} height={48} />
      ...
      {/* Linha visual compondo com o texto */}
              <Image src="/images/twolines.png" alt="" className="w-full h-3 object-cover select-none pointer-events-none my-4" draggable="false" width={400} height={12} />
      {/* Footer */}
